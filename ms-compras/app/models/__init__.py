...
class OrdenCompraDetalle(Base):
    ...
    producto_nombre: Mapped[str | None] = mapped_column(String(200))
    cantidad: Mapped[Decimal] = mapped_column(Numeric(14, 4), nullable=False)
    precio_unitario: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False)
    subtotal: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False)
...
class RecepcionCompra(Base, AuditoriaMixin):
    ...
    almacen_nombre: Mapped[str | None] = mapped_column(String(150))
    sucursal_id: Mapped[int | None] = mapped_column()
    sucursal_nombre: Mapped[str | None] = mapped_column(String(150))
    compania_id: Mapped[int | None] = mapped_column()
