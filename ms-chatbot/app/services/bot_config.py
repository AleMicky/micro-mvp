...
OPCIONES_MENU = ["Ver catálogo", "Horario", "Ubicación", "Soporte"]
...
MENSAJE_ERROR_SERVICIO = "Lo sentimos, no pudimos completar tu solicitud. Intenta de nuevo en unos minutos."
